<?php
    ...
    */
    ...
    <div class="panel-heading simple-heading">Yönetim Paneli</div>
        ...
        <cms:if k_success >
            ...
            <cms:else />
                <div class="alert alert-success alert-icon">
                    ...
                    Paneli kullanabilmek için lütfen <a href="<cms:php> echo K_ADMIN_URL . K_ADMIN_PAGE; </cms:php>">giriş</a> yapınız.
                </div>
            </cms:if>
        <cms:else />
            <cms:if k_error >
            ...
            <div class="simple-btns">
                <button class="btn btn-primary" name="k_install" type="submit"><svg class="i"><use xlink:href="<cms:php>echo K_SYSTEM_THEME_URL;</cms:php>assets/open-iconic.svg#check"></use></svg>Kurulumu başlat</button>
            </div>
        </cms:if>
    </cms:form>
